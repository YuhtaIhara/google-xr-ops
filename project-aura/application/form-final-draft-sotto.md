...
> **✅ 提出済 (2026-06-12)**。 提出内容の確定記録 + 新セクション (use cases / stack rank) の verbatim は `submission-record-2026-06-12.md` 参照。 本 doc は以後 historical。
...
- [ ] portfolio URL 動作 (https://github.com/YuhtaIhara)、 pinned 2 個 (`even-memory-bridge` / `google-xr-ops`) + profile README (Pinned work 4 link、 sharepoint-rag 2 つは delight-ihara org へ redirect だが public 200) が live
- [ ] 添付ファイル PDF 準備
