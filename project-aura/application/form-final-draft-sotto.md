...
- [ ] portfolio URL 動作 (https://github.com/YuhtaIhara)、 pinned 2 個 (`even-memory-bridge` / `google-xr-ops`) + profile README (Pinned work 4 link、 sharepoint-rag 2 つは 別 org org へ redirect だが public 200) が live
- [ ] 添付ファイル PDF 準備
